...
const MedicationModal: React.FC<MedicationModalProps> = ({ onClose, onSave, initialData }) => {
  ...
  useEffect(() => {
    if (initialData) {
      setFormData({
        ...
        dosage_time: initialData.dosage_time,
        periodicity_hours: initialData.periodicity_hours,
